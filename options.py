...
class Options:
    """
    Class defining various options for training, debugging, and testing the FHDR model.
    """
    def __init__(self):
        """
        Initializes the Options class and set up argument parsing.
        """
    ...
    def parse(self):
        """
        Parses the arguments and returns the parsed options.
        """
        # parse the arguments
